...
class FileUtils {
    // Define a function to load and decode JSON data from a file
    static func loadJSONData<T: Decodable>(from filename: String, withExtension fileExtension: String, in testClass: XCTestCase.Type) throws -> T {
